 ...
 * 	default : 같은 패키지안에서 접근 //앞으로 거의 안쓸
 * 			  => 한 파일에 class 두개를 만들지 않는다 //앞으로 거의 안쓸
 ...
 * 				오라클에 저장
 * 			}
 * 			void memberJoin(Member m)  매개변수가 많으니 클래스나 배열 넘겨라 (Member클래스)
 * 			{
 * 			}
 */
class Value{
...
public class 접근지정어 {
	...
	public static void main(String[] args) {
		...
		Value a=new Value(); //a 랑 v가 같다 
		System.out.println("a="+a);
		swap(a);
		System.out.println("a.a="+a.a+",v.b="+a.b);
