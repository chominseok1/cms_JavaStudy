 ...
 *  	=> Object
 *  	   주요 기능)
 *  		finalize() : 소멸자 (메모리 할당 => 해제할떄 호출)
 *  		toString() : 객체를 문자열로 변환
 *  		clone() : 새로운 메모리를 생성할 때 복제
 *  		getClass() : 클래스 객체 읽어올때
 *  		equals() : 객체 비교
 *  		classA
 *  		A a=new A();
 *  		a.getClass();
 ...
 *  		class B extends A (A+Object)상속받음
 *  		---------------
 *  		=> super(A)
 */
class Student
{
	...
	public Student()
	{
		// 모든 클래스의 super는 Object
		hakbun=1; // this.은 생략이 가능 => 지역변수와 같은 이름일떄 구분
		name="홍길동";
