...
public class 라이브러리_String_1 {
	...
	public static void main(String[] args) {
		...
		String s1="Hello";// 같은 메모리 주소에 저장 일반 데이터형처럼 주로 사용한다
		String s2="Hello";// 같은 메모리 주소에 저장 
		...
		// 실제 => 저장된 데이터된 데이터값이 같은지 확인한다 : equals Object의 equals랑 다름
		// s1에 저장된 값과 s3에 있는 값이 같은지 확인
		if(s1.equals(s3))
		{
			System.out.println("s1과 s3는 같은 값을 갖고있다");
		}
		else
		{
			System.out.println("s1과 s3는 다른 값을 갖고있다");
		}
		//308 page => 문자열 결합 (+)
		String ss="Hello";
		String ss1="Java!!";
		String ss2=ss+ss1;
		System.out.println(ss2); // StringBuffer :메모리 공간 하나로 계속 붙여나가는
