 ...
 *   	  =counterTokenizer => 분리된 단어의 갯수
 *   	  =hasMortTokens() => 분리된 갯수만큼 반복문 수행
 ...
 *         
 *         =배열을 대체
 *         	String page="2"; (page*10)-10 오류남 Integer parseInt() 해야됨
 *         					  (page-1)*10  
 *         
...
public class 라이브러리_Calendar {
	...
	public static void main(String[] args) {
		...
		// 요일 구하기
		int week=c.get(Calendar.DAY_OF_WEEK)-1; // week => 1번부터 시작 그래서 -1 
