 ...
 *  			int a=10;
 *  			int b=0;
 *  			double d=a/(double)b; 0으로 나눠서 오류 발생 ==> 오류발생하면 catch로 이동
 *  			System.out.println(d); 에러나면 밑에 문장 (수행x)
 ...
 *   		-----------------------------
 *   		|							|
 *   	CheckException(존재 클래스x)	UnCheckException(존재 클래스x)
 *   		|반드시 예외처리				    |필요시에만 사용
 *   		|						RuntimeException
 *   		|								|
 ...
 *   		|							 윈도우/웹 =>
 *   		|							 => 주소란
 *   		|							 main.jsp?page =1 url주소 줄떄 붙여야함 띄우면 공백들어감
 *   	    |							 ------------------
 *   		|								=> 오류 " 1" 띄우면
 ...
 *   	=> 클래스명이 틀린 경우
 *   	Class.forName("com.sist.excption예외처리_1")
 *    .....
...
public class 예외처리_1 {
	static String s="Hello"; //null 주소 없음 /넣으면 주소생김
	static AAAAA a; //클래스는 선언만 하면 null값
	public static void main(String[] args) {
		...
		arr[1]=10; // 배열 범위 초과
		System.out.println("2");//디버깅
		if(s.equals("Hello"))
		{
			System.out.println("OK");
		}
		System.out.println("3");//디버깅
		int a=10;
		...
		//3. if은 주로 사용하는게 ==> 검색용도, 사용자 입력 제한...
		
		String page="1"; // 1 공백주면 오류남
