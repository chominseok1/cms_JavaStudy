...
public class 입출력_6 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(driver); //키를 주고 값을 얻어오는
		...
		Properties prop3=new Properties(); // 생성 
		prop2.setProperty("name", "홍길동"); //입력 set
