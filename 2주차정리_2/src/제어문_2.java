 ...
 *    	  반복수행 문장 ----------
 *    	}
 *    	초기값 => 조건식 ========> 수행문장 ====> 증가식 => 조건식 => 수행문장 =>증가식 =>조건식 =>수행문장
 *    			 |false(종료)
 *    					true
 *    			조건식 ========> 수행문장 ====> 증가식
 *    			 |false(종료)
 ...
 *    			{
 *    				continue;
 *    				System.out.println() => 오류 컨티뉴 브레이크 밑에 소스 코딩 불가능
 *    			}
 *    		}
 *    		for()
 *    		{
 ...
 *    		if()         else if()
 *    		else 		 else
 *    		------	다중 if else는 전체의 else 단일 if는 바로위에 if else 단일 if는 따로 동작 
 *    		
 */					 
...
public class 제어문_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(arr3); //[I@515f550a 주소가 다름 다른영역을 제어
