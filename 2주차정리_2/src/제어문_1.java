 ...
 *  		
 *  		선택문 : 네트워크 , 게임 (키값)
 *  		switch(정수,문자,문자열) ==> 해당위치로부터 break가 나올떄까지 수행
 *  					   -----
 *  		{
 *  			case "Find":
 *  			case "Search":
 ...
 *  			System.out.println(a);
 *  			break;
 *  		} ===>오류남 같은 블록 안에 같은 변수 블록을 하나하나 만들어줘야함
 *  		
 * 	2. 반복문
 * 		----------------목록,페이징 (화면 출력)
 * 		1) for : 반복횟수가 지정된 경우
...
public class 제어문_1 {
	...
	public static void main(String[] args) {
		...
		int j=0;
		int rowSize=10;
		int pagecnt=(page*rowSize)-rowSize; // start 10-10=0 
		/*
		 * 	start end
		 * 	0      9  => 1page
		 * 10     10  => 2page
		...
		try
		{	//FileWriter:파일쓰기, FileReader :파일읽기
			FileReader fr=
