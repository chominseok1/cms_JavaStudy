 ...
 * 		
 */
class Student //한명의 학생에 대한 정보를 은닉화
{
	private int hakbun;
	private String name;
	 ...
	 *   	{					----------- 매개변수
	 *   	 	int a=10; // 지역변수 ==> Stack 영역 // Heap stack 다른 영역이기에 
	 *   												같은이름 변수 사용가능
	 *   		==> 지역변수 우선순위
	 ...
	 *   		=> 변수명이 다른 경우
	 *   			1. 지역변수 => 멤버변수  지역변수에 찾고 없으면 멤버변수에서 찾는다
	 *   	}
	 *   }
	 */
...
public class 접근지정어_1 {
	...
	public static void main(String[] args) {
		...
		// 1. 변수의 초기값
		//    ----------- 생성자
		hong.setHakbun(1); //hong.hakbun=1 이랑 접근은 .set
		hong.setName("홍길동");
		hong.setKor(90);
		hong.setEng(89);
		hong.setMath(78);
