...
public class 문자열_5 {
	...
	public static void main(String[] args) {
		String[] music= {"Kitsch","CHRISTIAN","꽃","Ditto",
			...
			String s1=s.substring(6); //6번부터 맨마지막까지
			System.out.println(s1);
			String s2=s.substring(0,4);
			//맨마지막 숫자는 제외      -- 는 제외 endIndex-1
			System.out.println(s2);
			String s3=s.substring(6,10);
			System.out.println(s3);*/
		//String ssd="That That (Prod. & Feat. SUGA of BTS)";
		...
		String s=addr.substring(0,addr.lastIndexOf("지")); //=> addr.lastIndexOf("지") 괄호안의 인덱스 찾는다
		System.out.println(s);
		...
		String sss=str.replace("a", "b"); //a를 b로 바꿔라
		System.out.println(sss);
		String sss1=str.replace("Java", "Oracle"); //얘네 대소문자 구분함
