 ...
 *    					   상수형 변수
 *    						int a; ==> 오류 발생
 *    						int a=10; a의 값을 넣어야지 오류 안남
 *    						=> 컴파일시 자동으로
 *    						public static final int a=10; --자동추가
 *    						-------------------------------------
 *    							자동 추가가 된다
 *    -					--------------------------
 *    					메소드
 *    						구현이 안된 메소드
 *    						void display(); 선언만 하는 메소드를 가지고감
 *    						=> 컴파일시
 ...
 *    							interface A
 *    							{
 *    							 private int a=10; => 오류/ 인터페이스의 모든 메소드와 변수는 public
 *    							 (public abstract) void display();
 *    							}
 *    							class B implements A
 *    							{
 *    								오버라이딩 => 조건에서 오류 발생
 *    								void display() ==> 오류 //확장을 못해서 default로 축소 시켰으니 오류
 *    								{
 *    								}
 ...
 *    					=> 구현된 메소드(JDk 1.8 이상)
 *    					메소드
 *    						static void methodName() = public static void methodName()
 *    						------ public이 자동추가
 *    						{
 *    						}
 *    					---------------------------
 *    				}
 *    			*** 추상클래스, 인터페이슨 상속을 받는 경우
