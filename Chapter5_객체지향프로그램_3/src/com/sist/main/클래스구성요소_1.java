package com.sist.main; //main은 키워드(예약어)가 아님
//폴더 => 관련된 java파일 저장 => 찾기
//다른 패키지의 클래스를 불러올떄 반드시 import를 사용해야 된다
import java.util.*;
import java.io.*;
import java.net.*;
// import com.sist.main.클래스구성요소_1;  //패키지 다를경우 import써서 갖고옴
//	import com.sist.main.*;
// import java.util.*; import java.util.Scanner;
// 순서 패키지 임포트 클래스
// 주의점 : 키워드는 사용할 수 없다 (대소문자 구분 => 소문자 권장)
//숫자를 앞에 사용할 수 없다
// com.sist.class com.sist.public com.sist.int ==> 오류남 키워드 쓰면
